nano /home/deploy/.cortensor/.env
https://sepolia-arb-rpc.centertopup.com

Router node

Node Tester 2
0x0c045e148394b5d32E5Bf38147BeC8416d0D6aC4
bb87b6c129e9fe628c9bab0a7dc08917efea25b3f72442e93501965ffa51a052
https://lb.drpc.org/ogrpc?network=ethereum&dkey=AruntwN0jkn-jjG1fZby03AChxlLLnER8JUiPkfoZsMe

CMD:  gen-api-key
* API Key
        Result:  06982463-cbb4-4cd8-8cd2-b2445f9859aa
Updating /home/deploy/.cortensor/.env with new API_KEY
env/config file updated with new API_KEY

pkill -f cortensord
cortensord /home/deploy/.cortensor/.env routerv1

TELEGRAM_BOT_TOKEN="8363592627:AAGcqkVv_bec-X7qsTbrYNq1wEZLd0UpsNU"
CORTENSOR_API_URL="http://184.105.7.148:5010/api/v1//completions"
CORTENSOR_API_KEY="06982463-cbb4-4cd8-8cd2-b2445f9859aa"
CORTENSOR_SESSION_ID="45"
...
👤 User: Buat artikel tentang kopi

🤖 Bot:
Prompt asli kamu: 
"Buat artikel tentang kopi."

🔹 Versi perbaikan:
"Buat artikel 500 kata tentang sejarah kopi di Indonesia, gaya santai."

👉 Mau pakai yang mana?
[Pakai Asli] [Pakai Perbaikan]

---

(ketika pilih Pakai Perbaikan)

🤖 Bot:
Oke, berikut hasilnya dari Cortensor 👇
"Kopi pertama kali masuk ke Indonesia pada abad ke-17..."

🔹 Versi perbaikan:
saya ingin di dalam versi perbaikan ini, prompt yang dikirimkan ke cortensor itu tidak monoton selalu itu itu saja, tapi user bisa memilih 5 prompt
yang menurutnya sangat relevan

improved_prompts = [
        f"Buat artikel 500 kata tentang sejarah {user_prompt} di Indonesia, gaya santai.",
        f"Buat artikel singkat 300 kata tentang manfaat {user_prompt} bagi kesehatan.",
        f"Tuliskan artikel tentang {user_prompt}, fokus pada jenis-jenis kopi nusantara.",
        f"Buat artikel tentang tren {user_prompt} modern di Indonesia, gaya santai.",
        f"Tuliskan artikel edukatif tentang proses dari biji {user_prompt} hingga cangkir."

apakah bisa dibagian ini f"..... {user_prompt} ....." yang titiknya itu juga dibuat secara acak tetapi tetap sesuai dengan perintah prompt dari usernya
sehingga outputnya tidak monoton itu itu saja
