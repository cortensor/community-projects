...
import { addMessage, updateSession, endStream } from '@/store/slices/chatSlice';
    ...
    const connect = () => {
      ...
      es.onmessage = (event) => {
        ...
        dispatch(updateSession({ 
          sessionId: chatId, 
          updates: { isLoading, loadingMessage, lastTaskId: taskId, lastSessionId: sessionId } 
        }));

        if (status === 'ended' || status === 'error') {
          // Use Redux for end stream
          dispatch(updateSession({
            sessionId: chatId,
            updates: { isLoading: false, loadingMessage: undefined, lastTaskId: undefined, lastSessionId: undefined }
          }));
        }
        ...
        //       session.id === chatId
        //         ? { ...session, messages: [...session.messages, botMessage], isLoading: false, lastTaskId: undefined, lastSessionId: undefined }
        //         : session
        //     ))
        //   );
        // }
