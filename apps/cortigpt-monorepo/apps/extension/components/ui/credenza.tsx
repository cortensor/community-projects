...
const CredenzaContent = ({ className, children, ...props }: CredenzaProps) => {
  ...
  return (
    <CredenzaContent 
      className={cn(
        isMobile 
          ? "w-full max-w-none mx-0 px-4" // Full width on mobile with padding
          : "w-full max-w-[95vw] sm:max-w-[90vw] md:max-w-4xl lg:max-w-5xl xl:max-w-6xl", // Responsive width on desktop
        className
      )} 
      {...props}
    >
